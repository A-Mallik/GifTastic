...
//----------------------------------------------
     ...
     $(document).on("click", "button", function() { //on button click AFTER it was dynamically created with the middle
...
//----------------------------------------------
 ...
 //------------------For Bonus to add an additonal 10 gifs----------------------------
     ...
     //------------------For Bonus to save favorite gifs----------------------------
       $(document).on("dblclick", "img", function() {    //double click function to grab favorite gif
